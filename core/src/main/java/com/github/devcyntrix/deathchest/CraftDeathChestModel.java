...
@NoArgsConstructor
@AllArgsConstructor
public final class CraftDeathChestModel implements DeathChestModel {
    @Expose
    ...
    public CraftDeathChestModel(Location location, long createdAt, long expireAt, @Nullable OfflinePlayer owner, boolean isProtected) {
    ...
    public boolean equals(Object o) {
        ...
        CraftDeathChestModel that = (CraftDeathChestModel) o;
    ...
    public static CraftDeathChestModel deserialize(Map<String, Object> map, InventoryOptions options, PlaceholderController controller) {
        ...
        var model = new CraftDeathChestModel(location, createdAt, expireAt, owner, isProtected);
