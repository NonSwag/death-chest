...
public class ItemStackAdapter implements JsonDeserializer<ItemStack>, JsonSerializer<ItemStack> {
    ...
    private static @NotNull Map<String, Object> deserialize(Map<String, Object> o) {
        o.replaceAll((s1, o1) -> {
        ...
        o.computeIfPresent("enchants", (s1, enchantsMap) -> {
    ...
    public ItemStack deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        deserialize.computeIfPresent("meta", (s, o) -> {
            Map<String, Object> meta = deserialize((Map<String, Object>) o);
