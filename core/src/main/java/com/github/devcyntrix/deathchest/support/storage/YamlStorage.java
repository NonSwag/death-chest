...
public class YamlStorage implements DeathChestStorage {
     ...
     *
     * @param files the saved-chests file
     */
    private void migrateChests(File[] files, Logger logger) {
    ...
    @Override
    public void init(@NotNull DeathChestService plugin, @NotNull ConfigurationSection section) throws IOException {
